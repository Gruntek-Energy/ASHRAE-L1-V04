...
import { runAnalysis, type ApiResponse } from '../lib/api';
...
type Facility = {
  buildingName?: string;
  type: 'Office' | 'Retail' | 'Hotel' | 'Hospital' | 'School' | 'Warehouse' | 'Residential' | 'Other';
  yearBuilt?: number;
  area_m2: number;
  floors?: number;
  occupancy?: number;
  hours_per_week?: number;
  location?: string;             // city / emirate
  ...
  hvac?: {
    ...
    chillerMakeModel?: string;
    coolingCapacityTR?: number;
    numChillers?: number;
    boilersPresent?: boolean;
...
type Energy = {
  // Electricity (required for EUI)
  annual_kwh: number;

  // Split (optional)
  annual_cooling_kwh?: number;

  // Fuels (optional; for L1 note only)
  gas_annual_mmbtu?: number;
  diesel_annual_liters?: number;

  // Cost & carbon
  tariff_aed_per_kwh?: number;
  emission_factor_kg_per_kwh?: number; // default 0.35 UAE
  carbon_factor_kg_per_kwh?: number;   // alias for emission factor

  // Benchmark target
  best_possible_eui?: number;          // kWh/m²·yr (e.g. 110)
};
      ...
      <div className="card">
        ...
        <div className="grid">
          ...
          <div>
            ...
            <select
              value={facility.type}
              onChange={e => setFacility({ ...facility, type: e.target.value as Facility['type'] })}
            >
        ...
        <div className="grid">
          ...
          <div>
            ...
            <select
              ...
              onChange={e => setFacility({ ...facility, bms: { ...(facility.bms||{}), trending: e.target.value as any } })}
            >
        ...
        <div className="grid">
          <div>
            ...
            <select
              ...
              onChange={e => setFacility({ ...facility, hvac: { ...(facility.hvac||{}), systemType: e.target.value as any } })}
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={e => setFacility({ ...facility, hvac: { ...(facility.hvac||{}), boilerFuel: e.target.value as any } })}
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={e => setFacility({ ...facility, hvac: { ...(facility.hvac||{}), ventilationControl: e.target.value as any } })}
            >
        ...
        <div className="grid">
          <div>
            ...
            <select
              ...
              onChange={e => setFacility({ ...facility, lighting: { ...(facility.lighting||{}), predominant: e.target.value as any } })}
            >
          ...
          <div className="col2">
            ...
            <select
              ...
              onChange={e => {
                const opts = Array.from(e.target.selectedOptions).map(o => o.value) as Facility['lighting']['controls'];
        ...
        <div className="grid">
          <div>
            ...
            <select
              ...
              onChange={e => setFacility({ ...facility, envelope: { ...(facility.envelope||{}), glazing: e.target.value as any } })}
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={e => setFacility({ ...facility, envelope: { ...(facility.envelope||{}), insulationLevel: e.target.value as any } })}
            >
